...
M3Rendering.WidgetFabric = (function() {
    "use_strict";
    
    var _ExtJSFabric = function(ns, loader, storage, config) {
        /**
        ...
        M3Rendering.Deferred = (ns && deft && deft.Deferred && ns.create('Deft.Deferred')) ||
                               (qlib && qlib.defer);
        ...
        this.warmDeferred = M3Rendering.Deferred();
        ...
        this.getOrRegisterPromise = function(config) {
            ...
            var key, widgetClass = defaultWidgetCls, widgetConfig,
                deferred = M3Rendering.Deferred, df, promise;
            ...
            var loadConfigPromise = function(key) {
                ...
                .then(
                   function(loadedConfig) {
                    ...
                    // var msg = "WIDGET CONFIG LOAD-MISSED!"
                    // console.log(msg);
                    if (!config) {
        ...
        var waitLoad = function(config) {
            ...
            var wgt, outerPromise, deferred = M3Rendering.Deferred();
        ...
        this.createWidget = function(config) {
             ...
             */
            var wgt, that = this, outerPromise, innerDeferred = M3Rendering.Deferred();
    ...
    var Module = {
        ...
        create: function(namespace, loader, storage, config) {

            if (Ext && namespace === Ext) {

                return new _ExtJSFabric(Ext, loader, storage, config);
