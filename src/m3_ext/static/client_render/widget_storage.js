...
M3Rendering.WidgetStorage = (function() {
    "use_strict";
    var t = 0;
        t = "";
    var _ExtRegister = function(config) {
    ...
    var _ExtJSStorage = function(ns, config) {
        ...
        this.createRegistry = function(customRegistrator, optionalConfig) {
            ...
            var registratorCls = customRegistrator || _ExtRegister,
        ...
        this.get = function(xtype) {
            /**
             * метод получения записи из хранилища по его уникальному ключу  *  xtype
             */
            var cls;
    ...
    var Module = {
        create: function(namespace, config) {
            ...
            if (Ext && namespace === Ext) {
                return new _ExtJSStorage(Ext, config);
            }
        }
    }
