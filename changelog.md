## История изменений
**2.0.8.19.1**
- Хотфикс - исправлена ошибка при определении нередактируемости поля при рендере поля. Также добавлен атрибут readOnly в шаблон ExtForm

**2.0.8.19**
- Добавлен атрибут read_only для класса контейнерных компонентов и проверка на возможность поставить флаг read_only для дочерних элементов контейнера
  
**2.0.8.18**
- Удалено дополнительное поведение для выведения на передний план окна при наличии окна сообщения

**2.0.8.17**
- Добавлен разделитель для label

**2.0.8.16**
- Исправлена ошибка выведения на передний план окна при наличии окна сообщения
- Исправлен комментарий к BaseExtField.min_length

**2.0.8.15**
- Добавлен плагин, который при выборе месяца заполняет дату его последним днём

**2.0.8.14**
- Доработано выделение через shift в гридах

**2.0.8.13**
- Исправлена ошибка конвертации строк в ExtTextArea при передачи в javascript

**2.0.8.12**
- Исправлена ошибка конвертации строк при передачи в javascript

**2.0.8.11**
- Исправлена ошибка с исчезновением вертикального скролла в таблицах с группировкой.
- Исправлена неверное сообщение о номерах строк, которые отображены в окне.

**2.0.8.10**
- Доработно отображение m2m-полей

**2.0.8.9**
- Заменен загрузчик шаблонов на совместимый с Django 2.*

**2.0.8.8**
- Исправление ошибки с обработкой строк при json.decode в AdvancedComboBox

**2.0.8.7**
- Исправлена ошибка с неработающим параметром hide_label у ExtCheckBox
- Исправление ошибки с отображением кнопки очистки при отсутствии значений у AdvancedComboBox

**2.0.8.6**
- Добавлен вызов get_display_record в биндинге ExtDictSelectField

**2.0.8.5**
- Добавлен сигнал, отправляемый после инициализации кэша класса DesktopLoader

**2.0.8.4**
- Исправлено наложение друг на друга кнопок группировки грида при удалении кнопки

**2.0.8.3**
- Добавлена возможность отключения разбиения числа на тысячные разряды в Ext.form.NumberField

**2.0.8.2**
- Исправлено наложение друг на друга кнопок группировки грида при работе с ними
...
**2.0.7.30**
- Добавлено экранирование обратных слешей в ExtHTMLEditor
- Исправлено отображение (css) группирующих колонок в браузере Google Hrome.
...
- Исправление бага, когда к компонентам окна применялся make_read_only,
  строка поиска была не редактируема, теперь поиск возможен.
- Перенесено добавление строки поиска в гриде в метод грида.
- Устранена проблема передачи значения поля MultiSelectField в POST параметрах из-за
 перекрытия hidden_name значением client_id.
 - Исправлено отображение (css) группирующих колонок в браузере Mozila FireFox.
